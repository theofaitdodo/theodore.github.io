...
Tous les outils sont des outils qui nous sont soit fournis gratuitement par les services de l'université Laval où ils sont en libre accès sur le web; aucun des outils présenté n'est payant pour un étudiant de l'université. La plupart sont des logiciels propriétaires, mais certains sont Open Source (Zotero). Si possible j'aurais aimé utiliser d'autre outils Open Source comme celui présenté par votre collègue Antoine Lemor (LLM tool), cependant  j'ai été restreint dans le temps. L'idée générale derrière l'utilisation des outils utilisée et leur apport complémentaire et non subsitutif à mon travail. Ils viennent combler certains besoins, par exemple trouvent des sources pour moi et les résument, mais le contenu est le produit de mon travail et est perfectionné grâce à tous ces outils. Ils permettent de préciser et rendre un travail fini beaucoup plus appréciable, toutefois j'essaye d'en faire une utilisation complémentaire tant que possible. 
